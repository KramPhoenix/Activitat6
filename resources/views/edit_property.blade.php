@extends('layouts.app')
@section('content')
    <form class="w-100 col-lg-12 mt-4 mb-4 d-flex justify-content-center" action="{{ route('myproperties.update', $id) }}" method="post">
        @method('post')
        @csrf
        ...
        <div class="col-lg-8">
            <div class="card card-default">
                ...
                <div class="col-12 d-flex justify-content-end text-center mb-4">
                    <a href="{{ route('myproperties.index') }}"><div class="btn btn-outline-danger mx-1">Cancelar</div></a>
